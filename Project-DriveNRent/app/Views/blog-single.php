	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item"><a href="<?= base_url('view/about') ?>" class="nav-link">About</a></li>
                 <li class="nav-item"><a href="<?= base_url('view/features') ?>" class="nav-link">Features</a></li>
                    <li class="nav-item"><a href="<?= base_url('view/pricing') ?>" class="nav-link">Pricing</a></li>
                    <li class="nav-item"><a href="<?= base_url('view/solution') ?>" class="nav-link">Solution</a></li>
                   <li class="nav-item"><a href="#divlogin" button class="nav-link">Login</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
