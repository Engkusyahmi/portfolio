...
│
├── images/                  # Static media assets & user graphics
...
├── index.html               # Main Single Page Application (SPA) & Dynamic Portfolio Hub
├── README.md                # Technical documentation and repository map
│
├── Project-Aquamonitor/     # Full Local Source Code: Flutter Mobile App & PHP API Backend
