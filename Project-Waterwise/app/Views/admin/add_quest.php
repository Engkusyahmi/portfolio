...
<div class="row mb-4">
    <div class="col-md-8">
        ...
        <p class="text-muted">Create a new quest</p>
    </div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= base_url('/admin/add-quest') ?>">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control <?= isset($validation) && $validation->hasError('xp_reward') ? 'is-invalid' : '' ?>" 
                           id="xp_reward" name="xp_reward" value="<?= old('xp_reward') ?>" min="1" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control <?= isset($validation) && $validation->hasError('ecopoints_reward') ? 'is-invalid' : '' ?>" 
                           id="ecopoints_reward" name="ecopoints_reward" value="<?= old('ecopoints_reward') ?>" min="1" required>
            ...
            <div class="row">
                <div class="col-12">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Create Quest
                    </button>
